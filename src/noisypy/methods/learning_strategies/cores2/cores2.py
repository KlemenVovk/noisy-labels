...
class SampleSieve(LearningStrategyModule):
    ...
    def training_step(self, batch: Any, batch_idx: int) -> STEP_OUTPUT:
        ...
        loss, clean_indicators = loss_cores(
            self.current_epoch,
            logits,
            y,
            noise_prior=self.cur_noise_prior.to(self.device),
        )
    ...
    def on_train_epoch_end(self):
        ...
        self.cur_noise_prior = (
            self.initial_noise_prior * self.num_training_samples
            - self.noisy_class_frequency
        )
