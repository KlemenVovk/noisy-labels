...
class SOP(LearningStrategyModule):
    def __init__(
        ...
        lr_u: float,
        lr_v: float,
        overparam_optimizer_cls: Type[Optimizer],
        overparam_weight_decay: float,
        overparam_momentum: float,
        overparam_mean: float,
        overparam_std: float,
        *args: Any,
        **kwargs: Any,
    ) -> None:
        ...
        self.criterion = overparametrization_loss(
            num_examp=self.num_training_samples,
            num_classes=self.num_classes,
            ratio_consistency=self.ratio_consistency,
    ...
    def configure_optimizers(self) -> list[list[Optimizer], list[LRScheduler]]:
        ...
        overparametrization_params = [
            {
                "params": self.criterion.u,
                "lr": self.lr_u,
                "weight_decay": self.overparam_weight_decay,
                "momentum": self.overparam_momentum,
            },
            {
                "params": self.criterion.v,
                "lr": self.lr_v,
                "weight_decay": self.overparam_weight_decay,
                "momentum": self.overparam_momentum,
            },
