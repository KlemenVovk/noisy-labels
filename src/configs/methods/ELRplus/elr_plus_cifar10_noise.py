...
from configs.methods.ELR.elr_cifar10_noise import cifar10_index_noise_config
...
class cifar10_index_noise_config(cifar10_base_config):
    ...
    dataset_train_augmentation = [
        Compose([
        AddNoise(noise=BiasedSymmetricNoise(num_classes=10, num_samples=50000, noise_rate=0.8)), AddIndex()])
        ]
